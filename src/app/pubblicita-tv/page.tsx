...
export const metadata: Metadata = {
  title: "Pubblicità TV: spot locali e nazionali | inCambio",
  description:
    "Pianificazione spot TV su reti locali e nazionali. Strategia media, acquisto spazi, creatività e KPI. Possibile pagamento in cambio merce.",
  alternates: { canonical: "https://www.incambio.eu/pubblicita-tv" },
  openGraph: {
    title: "Pubblicità TV: spot locali e nazionali | inCambio",
    description:
      "Acquisto spazi TV, pianificazione flight, creatività e misurazione KPI. Anche in cambio merce.",
  ...
  twitter: {
    ...
    title: "Pubblicità TV: spot locali e nazionali | inCambio",
    description:
      "Pianificazione spot TV con KPI chiari e ottimizzazioni. Possibilità di cambio merce.",
...
const SERVICE_JSON_LD = {
  ...
  "@type": "Service",
  "name": "Pubblicità TV",
  "serviceType": "Television advertising (local & national)",
  "description":
    "Pianificazione di spot TV su reti locali e nazionali: strategia, acquisto spazi, creatività, KPI e ottimizzazioni. Possibile pagamento in cambio merce.",
...
const FAQ_JSON_LD = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Quanto costa uno spot TV?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Dipende da rete, fascia oraria, formato e periodo. Prepariamo un planning con forecast di copertura e KPI attesi prima di acquistare gli spazi."
      }
    },
    {
      "@type": "Question",
      "name": "Posso pagare gli spot TV con cambio merce?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Sì. In presenza di stock o servizi valorizzabili possiamo impostare una formula barter (cambio merce) integrata con amministrazione e logistica."
      }
    },
    {
      "@type": "Question",
      "name": "Quanto deve durare lo spot?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "I formati più comuni sono 15”, 20” e 30”. Definiamo creatività e durata in base agli obiettivi di campagna e al budget disponibile."
      }
    }
  ]
};
    ...
    <main className="min-h-screen bg-black text-zinc-100">
      ...
      <section className="mx-auto max-w-5xl px-6 pb-10 pt-6">
        ...
        <p className="mt-4 max-w-3xl text-zinc-300">
          Pianifichiamo <strong>spot TV</strong> su reti locali e nazionali:
          strategia media, <strong>acquisto spazi</strong>, coordinamento
          creativo e <abbr title="Key Performance Indicators">KPI</abbr> con
          ottimizzazioni per massimizzare <abbr title="Return On Investment">ROI</abbr>.
          Se hai stock o servizi, possiamo valutare il <strong>cambio merce</strong>.
        </p>

        <div className="mt-8">
          <Image
            src="/images/Settembre-2025.png"
            alt="Pianificazione spot TV su reti locali e nazionali"
            width={1200}
            height={630}
      ...
      <section className="mx-auto max-w-5xl px-6 pb-14">
        ...
        <p className="mt-3 text-zinc-300">
          ...
          disponibile. Usiamo stime di audience e benchmark per scegliere
          reti, fasce e break più performanti.
        </p>
        ...
        <div className="mt-6 space-y-5">
          <details className="rounded-lg border border-white/10 bg-white/[0.02] p-4">
            <summary className="cursor-pointer text-white">
              Quanto costa uno spot TV?
            </summary>
            <p className="mt-3 text-zinc-300">
              Il costo varia da rete, fascia e durata. Ti forniamo un planning
              con stime di copertura e KPI attesi prima dell’acquisto spazi.
            </p>
          </details>
          <details className="rounded-lg border border-white/10 bg-white/[0.02] p-4">
            <summary className="cursor-pointer text-white">
            ...
            <p className="mt-3 text-zinc-300">
              Sì, valutiamo formule barter in presenza di stock/servizi idonei.
            </p>
          </details>
          <details className="rounded-lg border border-white/10 bg-white/[0.02] p-4">
            <summary className="cursor-pointer text-white">
            ...
            <p className="mt-3 text-zinc-300">
              15”, 20” e 30” sono i più usati. La scelta dipende da obiettivi e
              creatività: ti supportiamo nella definizione.
            </p>
          </details>
        </div>
      </section>
