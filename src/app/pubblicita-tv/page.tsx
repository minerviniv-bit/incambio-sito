...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Pubblicità TV | inCambio",
    description:
      "Strategia, pianificazione e acquisto spazi pubblicitari TV (locali e nazionali). Soluzioni in cambio merce per aziende con stock o servizi.",
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Il costo dipende da rete, fascia e durata. Prepariamo un planning con stime di copertura e KPI attesi.",
      },
    },
    {
      "@type": "Question",
      name: "Posso pagare con cambio merce?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Sì, valutiamo formule barter in presenza di stock o servizi idonei.",
      },
    },
    {
      "@type": "Question",
      name: "Qual è il formato migliore?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "I più diffusi sono 15”, 20” e 30”. La scelta dipende dagli obiettivi e dalla creatività.",
      },
    },
  ],
};
    ...
    <main className="min-h-screen bg-black text-zinc-100">
      ...
      <section className="mx-auto max-w-5xl px-6 pb-10 pt-6">
        ...
        <p className="mt-4 max-w-3xl text-zinc-300">
          ...
          ottimizzazioni per massimizzare{" "}
          <abbr title="Return On Investment">ROI</abbr>. Se hai stock o servizi,
          possiamo valutare il <strong>cambio merce</strong>.
        </p>
      ...
      <section className="mx-auto max-w-5xl px-6 pb-14">
        ...
        <ul className="mt-4 list-disc pl-5 text-zinc-300">
          <li>
            Analisi obiettivi e definizione <strong>strategia media</strong>.
          </li>
          <li>
            Planning e <strong>acquisto spazi</strong> su reti locali e
            nazionali.
          </li>
          <li>
            Coordinamento <strong>creatività</strong> (formati 15-20-30″).
          </li>
          <li>
            Report <strong>KPI</strong>, ottimizzazioni e stime <strong>ROI</strong>.
          </li>
